...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-liberu-executive-insights?sort=semver)](https://github.com/liberusoftware/module-liberu-executive-insights/releases/latest) [![Tests](https://github.com/liberusoftware/module-liberu-executive-insights/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-liberu-executive-insights/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-liberu-executive-insights
```
...
<a href="https://github.com/liberusoftware/module-liberu-executive-insights/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-liberu-executive-insights" alt="Contributors to liberusoftware/module-liberu-executive-insights">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-liberu-executive-insights/graphs/contributors).
